...
const ItemProduct = () => {
    return (
        <Link to={''} className={'w-full shadow rounded relative'}>
            <div className="absolute top-1 left-1 bg-red-700 text-white px-3 text-xs rounded-xl font-bold z-10">VIP
            </div>
            ...
            <div className="bg-white p-5">
                ...
                <div className="line-clamp-2">
                    <div
                        ...
                        0% trong 36 tháng.<br/>- Thanh toán sớm CK 18% + CK dòng tiền 11%.<br/>- Hỗ trợ tiền hoàn thiện
