        ...
        <div>
            <div className="flex bg-white shadow py-2 items-center sticky top-[60px] z-40">
                <div className="flex px-5 font-bold  ">
                    <Link to={'/nha-ban'}
                          className={`px-3 py-1  rounded-l w-[100px] text-center ${location.pathname.includes('nha-ban') ? 'text-white bg-gray-600' : 'border border-r-0'}`}>Bán</Link>
                    <Link to={'/nha-cho-thue'}
                          className={`px-3 py-1  rounded-r w-[100px] text-center ${location.pathname.includes('nha-cho-thue') ? 'text-white bg-gray-600' : 'border border-l-0'}`}>Cho thuê</Link>
                </div>
            ...
            <div className="my-5 px-72">
                ...
                <div className="mt-5 text-2xl font-bold">Cho thuê nhà đất trên toàn quốc</div>
